...
<div class="main">
    ...
    <form action="{{ route('admin.movies.update', $movie->id) }}" method="POST" style="max-width: 700px;">
        @csrf
        @method('PUT')
        ...
        <div class="w3-section">
            ...
            <textarea class="w3-input w3-border" name="description" rows="4" placeholder="Movie description...">{{ old('description', $movie->description) }}</textarea>
            @error('description')
                <small style="color: red;">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border" type="number" step="0.01" name="duration" 
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border" type="date" name="release_date" 
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border" type="number" step="0.1" min="0" max="10" name="rating" 
        ...
        <div class="w3-section">
            ...
            <select class="w3-select w3-border" name="genre_id" required>
                <option value="" disabled {{ old('genre_id', $movie->genre_id) ? '' : 'selected' }}>Choose genre</option>
        ...
        <div class="w3-section">
            ...
            <input class="w3-input w3-border" type="text" name="language" 
